...
% dictionary
	...
	dictionary(-endurant_hommes,les hommes ne sont pas endurants)
	dictionary(-endurant_femmes,les femmes ne sont pas endurantes)
	...
	dictionary(capable_hommes_5_sets,les hommes sont capables de jouer en 5 sets)
	dictionary(capable_hommes_3_sets,les hommes sont capables de jouer en 3 sets)
	...
	dictionary(capable_femmes_5_sets,les femmes sont capables de jouer en 5 sets)
	dictionary(audience_femmes,les matchs feminins ont une bonne audience)
	dictionary(audience_hommes,les matchs masculins ont une bonne audience)
	dictionary(endurant_hommes,les hommes sont endurants)
	dictionary(egalite_femmes_hommes,il y ait egalite homme-femme)
	dictionary(-egalite_femmes_hommes,il n y a pas egalite homme-femme)
	dictionary(-capable_femmes_5_sets,les femmes sont incapables de jouer en 5 sets)
	dictionary(-capable_femmes_3_sets,les femmes sont pas capables de jouer en 3 sets)
	dictionary(-capable_hommes_5_sets,les hommes sont incapables de jouer en 5 sets)
	dictionary(-capable_hommes_3_sets,les hommes sont incapables de jouer en 3 sets)
	dictionary(endurant_femmes,les femmes sont endurantes)
	dictionary(-audience_femmes,les matchs feminins ont une mauvaise audience)
	dictionary(-audience_hommes,les matchs masculins ont une mauvaise audience)
